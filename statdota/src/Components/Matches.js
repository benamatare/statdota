  ...
  return (
    <Table
      ...
      {props.matches.map((match, index) => {
        return(
          <TableRow key={index}>
            <TableRowColumn><img src={heroes[match.hero_id].img}/><br></br> {heroes[match.hero_id].localized_name} <br></br> {match.player_slot <= 127 ? "Dire" : "Radiant"}{laneRole(match.lane)}</TableRowColumn>
